    ...
    <section className="relative max-w-screen-xl mx-auto px-4 py-28 gap-12 md:px-8 flex flex-col justify-center items-center">
      ...
      >
        ...
        >
          ...
          <AccordionItem key="4" aria-label="¿Why NextUI?" title="¿Why NextUI">
            {defaultContent}
          </AccordionItem>
          <AccordionItem key="5" aria-label="¿Why NextUI?" title="¿Why NextUI?">
            {defaultContent}
          </AccordionItem>
          <AccordionItem key="6" aria-label="¿Why NextUI?" title="¿Why NextUI?">
            {defaultContent}
          </AccordionItem>
          <AccordionItem key="7" aria-label="¿Why NextUI?" title="¿Why NextUI">
            {defaultContent}
          </AccordionItem>
          <AccordionItem key="8" aria-label="¿Why NextUI?" title="¿Why NextUI?">
            {defaultContent}
          </AccordionItem>
          <AccordionItem key="9" aria-label="¿Why NextUI?" title="¿Why NextUI?">
            {defaultContent}
          </AccordionItem>
        </Accordion>
      </motion.div>
